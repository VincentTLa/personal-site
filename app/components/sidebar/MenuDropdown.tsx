...
function MenuDropdown() {
  ...
  return (
    <motion.nav
      className="fixed z-50 top-0 right-0 bottom-0 w-[300px]"
      initial={false}
    ...
    >
      <motion.div
        className="fixed top-0 right-0 bottom-0 w-[300px] bg-gradient-to-br from-slate-50 to-gray-200 border border-slate-200"
        variants={sidebar}
      />
